...
public static void main(String[] args) {
	...
	try {
		...
		while(true) {           //while is used for receiving infinite msg
			Socket s = skt.accept();      //accept msg from client
			...
			while(true) {            //used protocol for msg receiving and for read
				String out = din.readUTF();
				JPanel panel = formatLabel(out);
				
				JPanel left = new JPanel(new BorderLayout());    //received ns showed on the left side
